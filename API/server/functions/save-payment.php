...
$transition_id = $payment['balance_transaction'];


$sql = "INSERT INTO `loan_paid`(`user_id`, `user_name`, `payment_id`, `transition_id`) VALUES ('$user_id','$user_name','$payment_id','$transition_id')";
